...
-- 12. 兵种树节点初始化（全国家）
-- 结构：
-- 每个国家独立一棵子树（可在前端切换 ALL/CN/JP/KR/GB 查看）
-- 根节点 -> 步/弓/骑 -> 特种分支
...
-- CN
(1001, 1001, NULL, 'CN', 0, NULL, 0, 0, -9, 0),
(2001, 2001, 1001, 'CN', 1, 'CN', 1, 500, -10, 1),
(2002, 2002, 1001, 'CN', 1, 'CN', 2, 500, -9, 1),
(2003, 2003, 1001, 'CN', 1, 'CN', 3, 1000, -8, 1),
(3001, 3001, 2002, 'CN', 2, 'CN', 5, 2000, -9, 2),

-- JP
(1101, 2101, NULL, 'JP', 0, 'JP', 0, 0, -3, 0),
(2101, 2101, 1101, 'JP', 1, 'JP', 1, 500, -4, 1),
(2102, 2102, 1101, 'JP', 1, 'JP', 2, 500, -3, 1),
(2103, 2103, 1101, 'JP', 1, 'JP', 3, 1000, -2, 1),
(3002, 3002, 2102, 'JP', 2, 'JP', 5, 2000, -3, 2),

-- KR
(1201, 2201, NULL, 'KR', 0, 'KR', 0, 0, 3, 0),
(2201, 2201, 1201, 'KR', 1, 'KR', 1, 500, 2, 1),
(2202, 2202, 1201, 'KR', 1, 'KR', 2, 500, 3, 1),
(2203, 2203, 1201, 'KR', 1, 'KR', 3, 1000, 4, 1),
(3003, 3003, 2202, 'KR', 2, 'KR', 5, 2000, 3, 2),

-- GB
(1301, 2301, NULL, 'GB', 0, 'GB', 0, 0, 9, 0),
(2301, 2301, 1301, 'GB', 1, 'GB', 1, 500, 8, 1),
(2302, 2302, 1301, 'GB', 1, 'GB', 2, 500, 9, 1),
(2303, 2303, 1301, 'GB', 1, 'GB', 3, 1000, 10, 1),
(3004, 3004, 2302, 'GB', 2, 'GB', 5, 2000, 9, 2)
