...
public class BattleConstants {
    ...
    // 数值常量
    public static final int VAL_POISON_DMG = 50; // 每回合中毒伤害
    public static final int VAL_HOT_HEAL = 50;   // 每回合持续治疗
    public static final int VAL_HEAL_BIG = 200;  // 直接治疗量
    public static final int VAL_HEAL_TROOP = 100; // 小兵治疗量
    public static final double MULT_GENDER_ADVANTAGE = 1.5;
    public static final double MULT_VULNERABLE = 1.3;
    public static final double PCT_REFLECT = 0.3; // 30% 反伤
    ...
    public static final String SKILL_ATK_AMBUSH_ARCHER_VOLLEY = "ATK_AMBUSH_ARCHER_VOLLEY"; // 通过特殊钩子触发
